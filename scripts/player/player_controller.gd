...
## Coordinates locomotion components, facing direction, camera look-ahead, and state machine.
...
func _physics_process(delta: float) -> void:
	...
	# Execute locomotion calculations
	if movement != null:
		movement.process_physics(self, delta)
		
		# Update horizontal facing direction
